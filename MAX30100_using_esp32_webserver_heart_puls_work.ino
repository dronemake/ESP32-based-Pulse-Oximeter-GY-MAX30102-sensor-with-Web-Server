...
const char* ssid = "Esp32 host";  // Enter SSID here
...
String SendHTML(float BPM, float SpO2) {
  ...
  ptr += "#page { margin: 20px; background-color: #000;}";
  ...
  ptr += "<h1>MAX30100 ESP32 Using WebServer</h1>";
  ptr += "<h3><a>By Gajendra verma </a></h3>";
  ptr += "</div>";
